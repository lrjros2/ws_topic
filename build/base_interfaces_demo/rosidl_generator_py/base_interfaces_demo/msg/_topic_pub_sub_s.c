...
bool base_interfaces_demo__msg__topic_pub_sub__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces_demo.msg._topic_pub_sub.TopicPubSub", full_classname_dest, 51) == 0);
  }
  base_interfaces_demo__msg__TopicPubSub * ros_message = _ros_message;
  {  // a
...
{
  /* NOTE(esteve): Call constructor of TopicPubSub */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces_demo.msg._topic_pub_sub");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TopicPubSub");
